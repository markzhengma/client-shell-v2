  ...
  render() {
    return (
      <Navbar sticky = "bottom" className = "footer" style = {{ display: 'flex', flexDirection: 'column', padding: '40px' }}>
        ...
        <div className = "footer-info">
            <a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=15070202000139" style={{display:'inline-block',textDecoration: 'none', height:'20px', lineHeight:'20px'}}>
